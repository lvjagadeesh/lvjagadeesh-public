...
container_registries = {
  # Premium registry with all advanced features enabled
  "premium_registry" = {
    # Required variables
    name                = "premiumacr2024"
  ...
  # Standard registry with network restrictions
  "standard_registry" = {
    name                          = "standardacr2024"
    resource_group_name           = "production-rg"
    location                      = "East US"
    sku                           = "Standard"
    admin_enabled                 = false
  ...
  # Basic registry for development
  "basic_dev_registry" = {
    name                = "basicdevacr2024"
